 ...
 *                        stdout, logger=http stream; redacted headers +
 *                        capped bodies on the same line (HTTP_LOG_PAYLOAD,
 *                        default always). ON by default; HTTP_LOG=off
 *                        disables (e.g. local dev, test runs).
 * Tracing stays silent without an endpoint.
 *
